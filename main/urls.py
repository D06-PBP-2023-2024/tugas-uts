...
urlpatterns = [
    ...
    path('comment-flutter/', views.comment_book_flutter,
         name='comment_book_flutter'),
    path('readinglist-flutter', views.add_reading_list_flutter,
         name='add_reading_list_flutter'),
